...
class PopupService : Service() {
    ...
    override fun onCreate() {
        ...
        // Create a notification channel to allow notifications
        createNotificationChannel()

        // Start the service as a foreground service with a notification
        startForegroundService()

        // Register a receiver to listen for updates on timer settings
        registerUpdateReceiver()

        // Initialize the timer with the settings from the data store
        initializeTimerFromSettings()
    }

    // Starts the service as a foreground service with a notification
    private fun startForegroundService() {
        // Create a notification that will be displayed while the service is running
        val notification = getNotification("Service läuft...")

        // Start the service in the foreground, ensuring it remains running
